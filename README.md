...
First problem I faced was which filters I need and how to fuse it. To find the best solution, I try many combination and finally I get it, and my combination is 
```python
